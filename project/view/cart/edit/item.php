			...
			<tbody>
				...
				<tr>
					...
					<?php if($item->getProduct()->getBase()): ?>
                        <td><img src="<?php  echo $item->getProduct()->getBase()->getImagePath();?>" alt="No Image Found" width="50" height="50"></td>
                    <?php else: ?>
                        <td>No Base Image</td>
                    <?php endif; ?>
					...
					<td><button type="button" class="cartItemRemove btn btn-primary" value="<?php echo $item->itemId; ?>">Remove</button></td>
				</tr>
				<?php $i++; ?>
				<?php endforeach; ?>
				<?php endif; ?>
