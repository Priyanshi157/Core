...
<div class="row">
    <div class="col-md-2">
        ...
        <div class="card card-primary">
            <button class="btn btn-block btn-primary" type="button" id="addNew">Add New Cart</button>
        </div>
    </div>
</div>
<br>
...
<table class="table table-bordered table-striped">
    ...
    <?php foreach($orders as $order): ?>
        <tr>
            ...
            <td><button type="button" class="order btn btn-primary" value="<?php echo $order->orderId; ?>">View Order</button></td>
        </tr>
    <?php endforeach; ?>
    <?php endif; ?>
    </tbody>
